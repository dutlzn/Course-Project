									...
									<v-row>
										<v-col cols="12" md="12">
											<v-card-text class="mt-12">
												...
												<v-container>
													<v-text-field autocomplete="off" v-model="user.loginName" label="登录名" name="name" prepend-icon="person"
													 type="text" color="blue accent-3" />

													<v-text-field autocomplete="off" v-model="user.password" id="password" label="密码" name="Password"
													 prepend-icon="lock" type="password" color="blue accent-3" />
													<v-row class="d-flex align-center">

														<v-col cols="9">
															<v-text-field v-model="user.imageCode" id="imgCode" label="验证码" name="imgCode" prepend-icon="done"></v-text-field>
														</v-col>

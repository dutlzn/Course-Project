			...
			<div v-for="course in courses" class="col-md-4">
                ...
                COURSE_STATUS | optionKV(course.status)
						...
						<p>
							...
							<span class="badge badge-info">时长:{{ course.time | formatSecond }}
							</span>
						</p>
						<p>
							<button v-on:click="toChapter(course)" class="btn btn-white btn-xs btn-default btn-round">
								<i class="ace-icon fa fa-edit"></i>
								大章
							</button> &nbsp;

							<button v-on:click="editContent(course)" class="btn btn-white btn-xs btn-default btn-round">
								<i class="ace-icon fa fa-edit"></i>
								内容
							</button>&nbsp;

							<button v-on:click="openSortModal(course)" class="btn btn-white btn-xs btn-default btn-round">
								<i class="ace-icon fa fa-edit"></i>
								排序
							</button>&nbsp;
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button v-on:click="updateSort()" type="button" class="btn btn-primary">
							更新排序
						</button>
					</div>
				</div>
